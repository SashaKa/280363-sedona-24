...
* Студент: [Sasha Katushkova](https://up.htmlacademy.ru/htmlcss/24/user/280363).
* Наставник: `тест`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/280363-sedona-24) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
